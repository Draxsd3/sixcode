          ...
          <div className="relative grid lg:grid-cols-12 gap-8 lg:gap-10 items-end">
            <div className="lg:col-span-8">
              <div className="text-xs uppercase tracking-widest text-primary mb-6 flex items-center gap-3">
                ...
                <span>conversa gratuita · resposta em 24h</span>
              </div>
              ...
              <p className="text-background/70 text-base sm:text-lg max-w-xl">
                30 minutos de conversa, sem compromisso. Você nos conta o que
                quer resolver e a gente mostra um caminho — mesmo que no fim
                você decida não trabalhar com a gente.
              </p>
            </div>
